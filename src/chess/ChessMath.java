...
public class ChessMath {
	...
	private Piece makeMove(Position source, Position target) {
		...
		// Movimento especial ROCK do Rei lado direito
		if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
			Position sourceT = new Position(source.getRow(), source.getColumn() + 3); // "sourceT" é a posição inicial
																						// da torre a direita do rei
		...
		// Movimento especial ROCK do lado esquerdo da Rainha
		if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
			Position sourceT = new Position(source.getRow(), source.getColumn() - 4); // "sourceT" é a posição inicial
																						// da torre a direita do rei
			Position targetT = new Position(source.getRow(), source.getColumn() - 1);
			ChessPiece rook = (ChessPiece) board.removePiece(sourceT);
			board.placePiece(rook, targetT);
	...
	// criação da função 'Desfazer o movimento'
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		// Movimento especial ROCK do Rei lado direito
		if (p instanceof King && target.getColumn() == source.getColumn() + 2) {
			Position sourceT = new Position(source.getRow(), source.getColumn() + 3); // "sourceT" é a posição inicial da torre a direita do rei
			Position targetT = new Position(source.getRow(), source.getColumn() + 1);
	...
	// criação da função 'validateTargetPosition'=========================================
	...
	// Criação método 'NextTurn'==========================================================
	private void nextTurn() {
		turn++;
		// se o jogador atual for Branco então agora será Preto caso contrário será Branco
